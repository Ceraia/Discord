...
module.exports = class VoiceCommand extends Command {
        ...
        options: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                name: "reason",
                description: "reason for moving them",
                type: "STRING",
                required: false,
              },
            ],
  ...
  async interactionRun(interaction) {
    ...
    if (sub === "mute") response = await vmute(interaction, target, reason);
      ...
      const voiceChannel = await interaction.client.channels.cache.get(interaction.member.voice.channel.id);
      ...
      members.forEach(async (member) => {
        await move(interaction, member, reason, channel);
      });
      response = `Moved all members in ${voiceChannel.name} to ${channel.name}`;
    }
